...
<section id="footer" class="bg-white ">
      ...
      <div class="mx-auto max-w-4xl rounded-2xl bg-white/70 backdrop-blur-sm ring-1 ring-slate-200 p-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div class="hidden md:flex items-center justify-center gap-6">
            <img src="https://nexttrip-work.b-cdn.net/{{ $contact->qr_code }}" alt="LINE QR" class="h-28 w-28 rounded-lg ring-1 ring-slate-200 object-contain">
            <div class="text-sm">
              <a href="{{ $lineUrl }}" target="_blank" class="inline-flex items-center gap-2 rounded-full bg-[#00c300] px-4 py-2 text-white font-semibold">
                <img src="https://nexttrip-work.b-cdn.net/frontend/images/line_share.svg" class="h-5 w-5">
                {{ $contact->line_id }}
              </a>
  ...
  <div class="mx-auto max-w-7xl px-4 pb-10">
    ...
    @if($footer->status == 'on')
      <div class="mt-8">
        <img src="https://nexttrip-work.b-cdn.net/{{ $footer->img_footer }}" alt="" class="w-full rounded-xl ring-1 ring-slate-200">
      </div>
    @endif
  </div>
...
<div id="supportBar"
  ...
  <div class="flex items-center gap-3">
    <img src="https://nexttrip-work.b-cdn.net/frontend/images/customer_sercvice.webp" alt="" class="h10 w-20 object-cover rounded-xl">
    <div class="text-sm">
      ...
      <a href="{{ $lineUrl }}" target="_blank"
        ...
        <img src="https://nexttrip-work.b-cdn.net/frontend/images/line_share.svg" class="h-4 w-4" alt=""> {{ $contact->line_id }}
      </a>
    </div>
  </div>
</div>
