...
<header class="w-full border-b border-slate-100">
  ...
  <div class="md:hidden bg-white">
    <div class="mx-auto max-w-[1200px] px-3 py-2 grid grid-cols-3 items-center">
      ...
      <a href="{{ url('/') }}" class="justify-self-center">
        <img src="https://nexttripholidays.com/frontend/images/logo.svg" alt="Next Trip Holiday" class="h-8 w-auto"/>
      </a>
  ...
  <aside id="mobileMenu"
    ...
    <div class="flex items-center justify-between border-b
      ...
      <img src="https://nexttripholidays.com/frontend/images/logo.svg" class="h-8 w-auto" alt="Next Trip Holiday">
                ...
                @foreach($country_mb as $co)
                  <li>
                    <a href="{{ url('oversea/'.$co->slug) }}"
                      ...
                      <img src="https://nexttripholidays.com/{{ $co->img_icon }}"
    ...
    <div class="mx-auto max-w-[1200px] px-0">
      <div class="flex items-center py-1">
        ...
        <a href="{{ url('/') }}" class="shrink-0 mr-4">
          <img src="https://nexttripholidays.com/frontend/images/logo.svg" class="h-20 w-auto" alt="Next Trip Holiday">
        </a>
